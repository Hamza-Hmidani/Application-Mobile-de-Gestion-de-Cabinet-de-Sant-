...
public class signupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignup.setOnClickListener(v -> {
            ...
            if (userDao.getUserByEmail(emailTxt) != null) {
                Toast.makeText(this, "Cet email existe déjà ❌", Toast.LENGTH_LONG).show();
                return;
            }

            // INSERT INTO DATABASE
            user newUser = new user(0, nomTxt, prenomTxt, emailTxt, passwordTxt, "medecin", null);
